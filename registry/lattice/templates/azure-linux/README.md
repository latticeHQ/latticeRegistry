...
- Managed disk (persistent, mounted to `/home/wirtual`)

When the workspace restarts, any tools or files outside of the home directory are not persisted. To pre-bake tools into the agent environment (e.g. `python3`), modify the VM image or use a [startup script](https://registry.terraform.io/providers/wirtualdev/wirtual/latest/docs/resources/script).
